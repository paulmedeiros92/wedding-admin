        ...
        <div class="md-layout-item md-small-size-50">
          <md-field v-if="!form.isChild" :class="getValidationClass('food')">
            ...
            <md-select
              ...
              :disabled="sending"
            >
              <md-option v-for="food in adultFood" :value="food" :key="food">{{
                food
              }}</md-option>
            </md-select>
            <span class="md-error" v-if="$v.form.food.required"
              >The food is required</span
            >
          </md-field>
        </div>
      </div>
      ...
      <div class="md-layout-item md-size-100 md-layout md-gutter">
        <md-field>
          ...
          <md-textarea
            ...
            @keyup.enter.exact="validateUser"
            md-autogrow
          ></md-textarea>
        </md-field>
      </div>
